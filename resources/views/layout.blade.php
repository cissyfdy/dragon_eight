    ...
    <div class="sidebar" id="sidebar" style="width: 280px;">
        <div class="p-3">
            ...
            <nav class="nav nav-pills flex-column">
                ...
                <a class="nav-link {{ request()->routeIs('admin.tampilUnit') ? 'active' : '' }}" 
                   href="{{ route('admin.tampilUnit') }}">
                    <i class="bi bi-door-closed me-2"></i>
                    <span class="nav-text">Daftar Unit</span>
                </a>
                
                <a class="nav-link {{ request()->routeIs('admin.tampilMurid') ? 'active' : '' }}" 
                   href="{{ route('admin.tampilMurid') }}">
                    <i class="bi bi-people me-2"></i>
                    <span class="nav-text">Daftar Murid</span>
                </a>
                
                <a class="nav-link {{ request()->routeIs('admin.tampilPelatih') ? 'active' : '' }}" 
                   href="{{ route('admin.tampilPelatih') }}">
                    <i class="bi bi-person-badge me-2"></i>
                    <span class="nav-text">Daftar Pelatih</span>
                </a>
                
                <a class="nav-link {{ request()->routeIs('admin.tampilJadwal') ? 'active' : '' }}" 
                   href="{{ route('admin.tampilJadwal') }}">
                    <i class="bi bi-calendar3 me-2"></i>
                    <span class="nav-text">Jadwal Latihan</span>
                </a>
                
                <a class="nav-link {{ request()->routeIs('admin.tampilUjian') ? 'active' : '' }}" 
                   href="{{ route('admin.tampilUjian') }}">
                    <i class="bi bi-award me-2"></i>
                    <span class="nav-text">Ujian</span>
                </a>

                <a class="nav-link {{ request()->routeIs('admin.tampilIuran') ? 'active' : '' }}" 
                   href="{{ route('admin.tampilIuran') }}">
                    <i class="bi bi-wallet me-2"></i>
                    <span class="nav-text">Iuran</span>
                </a>
            </nav>
        </div>
    </div>
